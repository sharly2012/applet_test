...
from pages.page_changanjinmaofu import PageChangAnJinMaoFu
from utils.basefile import make_folder
from utils.baseutil import BaseUtil


@allure.MASTER_HELPER.feature("长安金茂府测试")
class TestChangAnJinMaoFu:

    @classmethod
    def setup_class(cls):
        cls.screenshots_folder = BaseUtil().root_path + "/screenshots/长安金茂府"
        ...
        # 打开微信
        cls.ele_page = PageChangAnJinMaoFu(cls.driver)
        ...
        cls.ele_page.send_keys(cls.ele_page.search_applet, "长安金茂府")
        cls.ele_page.sleep(3)
    ...
    def test_focus_images_02(self):
        ...
        self.ele_page.click(self.ele_page.focus_images)
        self.ele_page.sleep(3)
        self.ele_page.get_screenshots_by_slide_up(self.result_images, "jiaodiantu2", 7)
        self.ele_page.applet_back()
    ...
    @allure.MASTER_HELPER.severity("blocker")
    @allure.MASTER_HELPER.story("生活美学")
    @allure.MASTER_HELPER.testcase("生活美学测试")
    def test_beautiful_life(self):
        self.ele_page.click(self.ele_page.beautiful_life)
        self.ele_page.sleep(3)
        self.ele_page.get_screenshots_by_slide_up(self.result_images, "shenghuomeixue", 3)
        self.ele_page.applet_back()
    ...
    def test_house_type(self):
        ...
        self.ele_page.click(self.ele_page.house_type_01)
        self.ele_page.sleep(3)
        self.ele_page.get_screenshots_by_slide_up(self.result_images, "huxing_01", 3)
        self.ele_page.click(self.ele_page.house_type_02)
        self.ele_page.sleep(1)
    ...
    def test_surround_supporting(self):
        self.ele_page.click(self.ele_page.surround_supporting)
        self.ele_page.sleep(3)
        self.ele_page.get_screenshots_by_slide_up(self.result_images, "zhoubianpeitao", 3)
        self.ele_page.applet_back()
    ...
    def test_sample_area_walking(self):
        self.ele_page.click(self.ele_page.sample_area_walking)
    ...
    def test_sample_room_images(self):
        ...
        self.ele_page.sleep(3)
        self.ele_page.get_screenshot(self.result_images, "yangbanjiantu_01")
        self.ele_page.swipe_left()
        self.ele_page.swipe_left()
        self.ele_page.swipe_left()
        self.ele_page.get_screenshot(self.result_images, "yangbanjiantu_02")
        self.ele_page.applet_back()
    ...
    def test_technology(self):
        ...
        self.ele_page.sleep(3)
        self.ele_page.get_screenshots_by_slide_up(self.result_images, "fuxikeji", 5)
        self.ele_page.applet_back()
    ...
    def test_chat_online(self):
        ...
        self.ele_page.sleep(3)
        self.ele_page.get_screenshot(self.result_images, "im")
...
if __name__ == '__main__':
    pytest.main(["-s", "test_changanjinmaofu.py"])
