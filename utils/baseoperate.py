...
class BaseOperate(object):
    ...
    def __init__(self, driver):
        ...
        self.wait_time = 2
        self.path = "E:/PycharmProjects/wechat_test"
        self.logger = Logger(logger='BaseOperate').get_log()

    def reset(self):
        """reset driver"""
        self.logger.info("reset the driver ...")
        self.width = self.driver.get_window_size()['width']
        self.height = self.driver.get_window_size()['height']
        return self
    ...
    def find_element(self, *locator):
        ...
        try:
            ...
            self.logger.error('Can not find element: %s' % locator[1])
            raise
    ...
    def find_elements(self, by, value):
        ...
        try:
            ...
            self.logger.warning("Can not find elements: %s" % value)
            raise

    def click(self, locator):
        """click"""
        self.logger.info('Click element by %s: %s ...' % (locator[0], locator[1]))
        try:
            ele = self.find_element(*locator)
            ele.click()
        except AttributeError as e:
            self.logger.error("The element is unclickable: %s" % e)
    ...
    def clear_input(self, locator):
        ...
        try:
            element.clear()
            self.logger.info('Clear input-box by %s: %s ...' % (locator[0], locator[1]))
        except NameError as ne:
            self.logger.warning("Failed to clear in input box with %s" % ne)

    def send_keys(self, locator, text):
        """send keys"""
        ele = self.find_element(*locator)
        ele.clear()
        self.logger.info('Input element by %s : %s values %s ...' % (locator[0], locator[1], text))
        try:
            ele.send_keys(text)
    ...
    def tap(self, x, y):
        """tap element"""
        self.logger.info("Tap positions x: %s, y: %s ..." % (x, y))
        try:
    ...
    def sleep(self, sleep_time):
        """sleep"""
        self.logger.info("sleep %s seconds" % sleep_time)
    ...
    def get_element_text(self, locator):
        ...
        try:
            ...
            self.logger.info("Can't get the text of %s" % locator)
            self.logger.error(e)
    ...
    def swipe_up(self, duration=800, swipe_times=1):
        """swipe up"""
        self.logger.info("slide up the screen ...")
    ...
    def swipe_down(self, duration=800, swipe_times=1):
        """swipe down"""
        self.logger.info("slide down the screen ...")
        size = self.get_screen_size()
        x1 = int(size[0] * 0.5)
        y1 = int(size[1] * 0.25)
        y2 = int(size[1] * 0.75)
    ...
    def swipe_left(self, duration=800, swipe_times=1):
        """swipe left"""
    ...
    def swipe_right(self, duration=800, swipe_times=1):
        """swipe right"""
    ...
    def wechat_swipe_up(self, duration=1000):
        """wechat applet slide"""
        self.logger.info("wechat slide up")
        size = self.get_screen_size()
        x1 = int(size[0] * 0.5)
        y1 = int(size[1] * 0.75)
        y2 = int(size[1] * 0.25)
    ...
    def scroll_element1_to_element2(self, locator1, locator2):
        ...
        self.logger.info("scroll the screen from %s to %s" % (ele1, ele2))
        self.driver.scroll(ele1, ele2)

    def click_back(self):
        """click the back button, KEYCODE_BACK = 4"""
        self.logger.info("click the back button ...")
    ...
    def click_power(self):
        ...
        self.logger.info("click the power button ...")
    ...
    def is_displayed(self, locator):
        ...
        try:
            ...
            self.logger.info("Not exist this element %s" % e)
    ...
    def is_exist_current(self, text):
        ...
        if text in all_element:
            ...
            self.logger.info("Current page not exist %s" % text)
            return False

    def long_press(self, locator, duration=3000):
        """long press"""
        self.logger.info("long press % s" % locator)
        element = self.find_element(*locator)
    ...
    def hide_keyboard(self):
        """hide the keyboard"""
        self.logger.info("hide the keyboard ...")
    ...
    def get_screenshot(self, folder_name, case_name):
        ...
        self.logger.info("Screen shot had been saved: %s" % file_path)
        return file_path

    def launch_app(self):
        """launch the app"""
        self.logger.info("launch the app ...")
    ...
    def quit(self):
        """quit the driver"""
        self.logger.info("quit the driver ...")
        self.driver.quit()

    def set_ime(self):
        """Set the IME UnicodeIME"""
        self.logger.info("Set the current IME Appium UnicodeIME")
        try:
            self.driver.activate_ime_engine("io.appium.android.ime/.UnicodeIME")
        except Exception as e:
            self.logger.info("The Appium UnicodeIME is not installed: %s" % e)
    ...
    def assert_in(self, text):
        ...
        self.logger.info("Current page not exist %s, fail" % text)
    ...
    def assert_not_in(self, text):
        ...
        self.logger.info("Current page exist %s, fail" % text)
    ...
    def is_toast_show(self, message, wait=10):
        ...
        try:
            ...
            self.logger.info("[Toast] can't be found: %s" % locator)
            return False
    ...
    def image_to_string(self, locator):
        ...
        self.logger.info("verify code is: " + verify_code)
        return verify_code
    ...
    def get_screenshot_by_element(self, element, folder_name, image_name, image_form="png"):
        ...
        self.logger.info("The element had been saved in %s" % ele_image_path)
    ...
    def write_to_file(self, old_file, new_path, image_name, image_form="png"):
        ...
        if not os.path.isdir(new_path):
            ...
            self.logger.info("%s is exist" % new_path)
    ...
    def load_image(self, image_path):
        ...
        if os.path.isfile(image_path):
            ...
            self.logger.info("%s is not exist" % image_path)
            raise Exception
