...
class PageChangAnJinMaoFu(BaseOperate):
    discovery = (By.XPATH,
    ...
    beautiful_life = (By.XPATH, "//*[@resource-id='生活美学']/android.view.View[1]")
    house_type = (By.XPATH, "//*[@resource-id='项目介绍']/android.view.View[1]/android.view.View[3]")
    house_type_01 = (By.XPATH, "//*[@text='可滚动']/android.view.View[1]/android.view.View[1]/android.view.View[1]")
    house_type_02 = (By.XPATH, "//*[@text='A2户型-146㎡']")
    property_parameters = (By.XPATH, "//*[@resource-id='项目介绍']/android.view.View[1]/android.view.View[2]")
    surround_supporting = (By.XPATH, "//*[@resource-id='项目介绍']/android.view.View[1]/android.view.View[4]")
    sample_area_walking = (By.XPATH, "//*[@resource-id='示范区漫游']/android.view.View[1]")
    ...
    image_folder_03 = (By.XPATH, "//*[@text='项目实景图']")
